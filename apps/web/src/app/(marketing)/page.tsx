...
export default function LandingPage() {
   ...
   const handleLaunchClick = (e: React.MouseEvent) => {
      // WalletConnect component handles the modal
      if (!isConnected) {
         e.preventDefault();
      }
   };
   ...
   const steps = [
      {
         ...
         desc: 'SVM-native monitoring of Solana transactions — Pump.fun launches, Raydium LP creations, and whale accumulation — via Birdeye V3 sub-second indexing.',
         icon: <Database size={20} />
      },
      {
         title: 'NEURAL_FILTERING',
         desc: 'Solana-specific logic nodes analyze SPL token liquidity depth, on-chain security scores, and smart-money whale clusters.',
         icon: <Cpu size={20} />
      },
      {
         title: 'INSTANT_DISPATCH',
         desc: 'High-priority routing of validated Solana alpha signals to your Telegram with 1-click Jupiter swap deep-links.',
         icon: <Zap size={20} />
      }
   ];
   ...
   return (
      <div className="flex-1 flex flex-col relative overflow-hidden grid-bg">
         ...
         <div className="flex-1 flex flex-col items-center justify-center px-6 pt-12 md:pt-10 pb-16 md:pb-20 relative z-10 text-center">
            ...
            {/* Superteam Turkey x Colosseum Badge */}
            <div className="mb-10 animate-in fade-in slide-in-from-top-4 duration-700">
               <div className="inline-flex items-center gap-2.5 px-4 py-1.5 bg-[#121318] border border-[#9945FF]/30 rounded-full group hover:border-[#9945FF]/60 transition-all cursor-default">
                  <div className="w-4 h-4 bg-[#9945FF] rounded-full flex items-center justify-center text-[9px] font-black text-white">S</div>
                  <span className="text-[9px] font-bold font-mono text-[#849587] uppercase tracking-widest">
                     Superteam Turkey <span className="text-[#9945FF] mx-1">×</span> Colosseum Frontier 2026
                  </span>
               </div>
            </div>
            ...
            <h1 className="max-w-4xl text-2xl sm:text-3xl md:text-5xl font-bold tracking-tight text-white leading-[1.2] md:leading-[1.15] mb-6">
               The Solana-native intelligence terminal <br className="hidden sm:block" />
               <span className="text-mint">built for the Frontier.</span>
            </h1>

            <p className="max-w-xl text-[#849587] text-[11px] md:text-[13px] font-mono mb-10 leading-relaxed uppercase tracking-wide">
               Automate your on-chain alpha on Solana. Monitor Pump.fun launches, Raydium LPs,
               and whale clusters — with AI-powered signals dispatched directly to Telegram.
            </p>
            ...
            <div className="flex flex-col gap-6 mb-8 md:mb-12">
               <div className="space-y-2">
                  <h2 className="text-lg md:text-xl font-bold text-white uppercase tracking-tighter flex items-center gap-2">
                     <Activity size={18} className="text-mint" /> SOLANA_INTELLIGENCE_RADAR
                  </h2>
                  <p className="text-[10px] md:text-[11px] font-mono text-[#4a4b52] uppercase">SVM-native event monitoring — Pump.fun, Raydium, and Solana DEXs in real-time.</p>
               </div>
            ...
            <div className="max-w-6xl mx-auto flex flex-col items-center">
               ...
               <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-12 pt-16 border-t border-[#1c1d24]/50">
                  ...
                  <div className="space-y-4 text-left">
                     ...
                     <p className="text-[9px] font-mono text-[#4a4b52] leading-relaxed uppercase">
                        Catalyst Terminal is not a financial advisory service. All data presented is for informational purposes only. The platform cannot be held liable for losses resulting from software errors, data delays, or market manipulation.
                     </p>
                  </div>
               </div>

               <div className="mt-16 text-[8px] font-mono text-[#1c1d24] uppercase tracking-widest">
                  © 2026 Catalyst_Terminal // Solana_Intelligence_Hub
               </div>
            </div>
         </div>
